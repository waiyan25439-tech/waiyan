...
generated_keys = {}      
user_subscriptions = {}  
blocked_users = set()    # တစ်ဦးချင်း ပိတ်ထားသော User များ
global_lock = False      # Free User အားလုံးကို တစ်ခါတည်း အကုန်ပိတ်ရန် (True ဆိုလျှင် အားလုံးပိတ်မည်)
...
def check_user_limit(user_id: int) -> tuple[bool, str]:
    ...
    # တစ်ဦးချင်း ပိတ်ထားခြင်း (သို့) အားလုံးကို တန်းပိတ်ထားခြင်း (Global Lock) ရှိမရှိ စစ်ဆေးရန်
...
# ── GLOBAL ERROR HANDLER ────────────────────────────────_________________
...
def main():
    ...
    print("🤖 Telegram Bot Running with Global Lock & Single User Management...")
