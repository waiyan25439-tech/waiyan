...
# --- SPEED CONFIGURATION (Lag မဖြစ်စေရန် အကောင်းဆုံးချိန်ညှိထားသည်) ---
MAX_CONCURRENT = 50
BATCH_SIZE = 500
CONNECTION_LIMIT = 3000
CONNECTION_PER_HOST = 1500
TIMEOUT = 25
...
async def run_bruteforce(mode, chat_id, session_url, scan_id, progress_msg=None, start_digit=None):
    ...
    try:
        while True:
            ...
            # Telegram Bot မlag စေရန် UI Update ကို 1 စက္ကန့်လျှင် တစ်ကြိမ်သာ Rate-limit လုပ်ပြီး Edit မည်
            now = time.monotonic()
            ...
            # Event Loop လွတ်လပ်စေရန် အနည်းငယ် အနားပေးမည် (Lag ကာကွယ်ရန်)
